			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.xuhuan.model.Order o=(com.xuhuan.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.xuhuan.dao.UserDao userDao=new com.xuhuan.dao.UserDao();
						...
						<%
							...
							String paymentType=com.xuhuan.model.Payment.findByPaymentId(con,n);
							 %>
