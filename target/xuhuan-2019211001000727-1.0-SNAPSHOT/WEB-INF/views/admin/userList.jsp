		...
		<h2 class="title text-center">User <strong>List</strong></h2> 
				<table class="table table-condensed">
					...
					<c:forEach var="row" items="${allUser.rows}">
						<tr>
							<td class="cart_description"><p>${row.username}</p></td>
								<td class="cart_description">
								<p>${row.paasword}</p></td>
							<td class="cart_description"><p>${row.email}</p></td>
							<td class="cart_description"><p>${row.gender}</p></td>
							<td class="cart_description"><p>${row.birthDate}</p></td>
